                ...
                <form id="religionForm" novalidate enctype="multipart/form-data">
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control form-control-custom" id="description" name="description" rows="4"
                                placeholder="Short description about this religion"></textarea>
                        </div>
